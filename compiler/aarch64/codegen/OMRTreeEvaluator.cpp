    ...
    TR::Register *treg, uint32_t value)
{
    ...
    if (lower16bit == upper16bit) {
        ...
        return instr;
                   ...
                   = tryToGenerateImm32ShiftingOnesInstruction(node, cg, treg, OP::vmovi4s_one, value))) {
        return instr;
    } else if ((instr
                   = tryToGenerateImm32ShiftingOnesInstruction(node, cg, treg, OP::vmvni4s_one, ~value))) {
        return instr;
    }
    return NULL;
}
...
static const OP::Mnemonic vectorCompareOpCodes[NumVectorCompareOps][TR::NumVectorElementTypes] = {
    ...
    { OP::vcmeq16b, OP::vcmeq8h, OP::vcmeq4s, OP::vcmeq2d,
     OP::vfcmeq4s, OP::vfcmeq2d }, // EQ
    { OP::vcmeq16b, OP::vcmeq8h, OP::vcmeq4s, OP::vcmeq2d,
     OP::vfcmeq4s, OP::vfcmeq2d }, // NE (apply not after compare)
    { OP::vcmgt16b, OP::vcmgt8h, OP::vcmgt4s, OP::vcmgt2d,
     OP::vfcmgt4s, OP::vfcmgt2d }, // LT (flip lhs and rhs)
    { OP::vcmge16b, OP::vcmge8h, OP::vcmge4s, OP::vcmge2d,
     OP::vfcmge4s, OP::vfcmge2d }, // LE (flip lhs and rhs)
    { OP::vcmgt16b, OP::vcmgt8h, OP::vcmgt4s, OP::vcmgt2d,
     OP::vfcmgt4s, OP::vfcmgt2d }, // GT
    { OP::vcmge16b, OP::vcmge8h, OP::vcmge4s, OP::vcmge2d,
     OP::vfcmge4s, OP::vfcmge2d }, // GE
};
...
static const OP::Mnemonic vectorCompareZeroOpCodes[NumVectorCompareOps][TR::NumVectorElementTypes] = {
    ...
    //       TR::Float                     TR::Double
    { OP::vcmeq16b_zero, OP::vcmeq8h_zero, OP::vcmeq4s_zero,
     OP::vcmeq2d_zero, OP::vfcmeq4s_zero,OP::vfcmeq2d_zero                                                                 }, // EQ
    { OP::vcmeq16b_zero, OP::vcmeq8h_zero, OP::vcmeq4s_zero,
     OP::vcmeq2d_zero, OP::vfcmeq4s_zero,
     OP::vfcmeq2d_zero                                                             }, // NE (apply not after compare)
    { OP::vcmlt16b_zero, OP::vcmlt8h_zero, OP::vcmlt4s_zero,
     OP::vcmlt2d_zero, OP::vfcmlt4s_zero, OP::vfcmlt2d_zero }, // LT
    { OP::vcmle16b_zero, OP::vcmle8h_zero, OP::vcmle4s_zero,
     OP::vcmle2d_zero, OP::vfcmle4s_zero, OP::vfcmle2d_zero }, // LE
    { OP::vcmgt16b_zero, OP::vcmgt8h_zero, OP::vcmgt4s_zero,
     OP::vcmgt2d_zero, OP::vfcmgt4s_zero, OP::vfcmgt2d_zero }, // GT
    { OP::vcmge16b_zero, OP::vcmge8h_zero, OP::vcmge4s_zero,
     OP::vcmge2d_zero, OP::vfcmge4s_zero, OP::vfcmge2d_zero }, // GE
};
    ...
    TR::CodeGenerator *cg)
{
    ...
    if (isMasked) {
        ...
        if (notAfterCompare) {
            ...
            generateTrg1Src2Instruction(cg, flipMask ? OP::vbic16b : OP::vand16b, node,
...
static TR::Register *inlineVectorReductionOp(TR::Node *node, TR::CodeGenerator *cg, TR::DataType et,
    OP::Mnemonic op, reductionEvaluatorHelper evaluatorHelper = NULL)
{
    TR::Node *firstChild = node->getFirstChild();
 ...
 */
static TR::Register *vreductionHelper(TR::Node *node, TR::DataType et, OP::Mnemonic op,
    ...
    TR::CodeGenerator *cg)
{
    ...
    generateCondTrg1Src2Instruction(cg, OP::cselx, node, resReg, tmpReg, resReg,
    ...
    OP::Mnemonic op, binaryEvaluatorHelper evaluatorHelper)
{
     ...
     */
    generateTrg1Src2Instruction(cg, flipMask ? OP::vbit16b : OP::vbif16b, node, resReg, lhsReg,
        maskReg);
    ...
    OP::Mnemonic op, unaryEvaluatorHelper evaluatorHelper)
{
     ...
     * BIF inserts each bit from the first source if the corresponding bit of the second source is 0.
     */
    generateTrg1Src2Instruction(cg, flipMask ? OP::vbit16b : OP::vbif16b, node, resReg, srcReg,
        maskReg);
...
TR::Register *OMR::ARM64::TreeEvaluator::vmfmaEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
     ...
     * BIF inserts each bit from the first source if the corresponding bit of the second source is 0.
     */
    generateTrg1Src2Instruction(cg, flipMask ? OP::vbit16b : OP::vbif16b, node, targetReg,
        firstReg, maskReg);
    ...
    OP::Mnemonic op, loadIdentityVectorHelper loadHelper, reductionEvaluatorHelper evaluatorHelper = NULL)
{
     ...
     * BIF inserts each bit from the first source if the corresponding bit of the second source is 0.
     */
    generateTrg1Src2Instruction(cg, flipMask ? OP::vbif16b : OP::vbit16b, node, tmpReg,
        sourceReg, maskReg);
...
TR::Register *OMR::ARM64::TreeEvaluator::vmreductionMulEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
    ...
    TR::DataType et = node->getFirstChild()->getDataType().getVectorElementType();
    return inlineVectorMaskedReductionOp(node, cg, et, OP::bad, loadIdentityVectorForReductionMul,
        vreductionMulHelper);
}
...
TR::Register *OMR::ARM64::TreeEvaluator::vmreductionXorEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
    ...
    switch (et) {
        ...
        case TR::Int32:
        case TR::Int64:
            return inlineVectorMaskedReductionOp(node, cg, et, OP::bad, loadZeroVector,
                vreductionXorHelper);
        case TR::Float:
        case TR::Double:
            TR_ASSERT_FATAL_WITH_NODE(node, false, "Unexpected element type %s",
...
static TR::Register *vectorShiftImmediateHelper(TR::Node *node, TR::CodeGenerator *cg)
{
    ...
    if ((value >= start) && (value <= end)) {
        ...
        TR::Register *lhsReg = cg->evaluate(firstChild);
        OP::Mnemonic op
            = static_cast<OP::Mnemonic>((isLeftShift                  ? OP::vshl16b
        ...
        if (isVectorMaskedShift) {
             ...
             * BIF inserts each bit from the first source if the corresponding bit of the second source is 0.
             */
            generateTrg1Src2Instruction(cg, flipMask ? OP::vbit16b : OP::vbif16b, node,
    ...
    TR::Register *rhsReg, TR::CodeGenerator *cg)
{
    ...
    OP::Mnemonic negOp
        = static_cast<OP::Mnemonic>(OP::vneg16b + (elementType - TR::Int8));
    OP::Mnemonic shiftOp = static_cast<OP::Mnemonic>(
        (isLogicalShift ? OP::vushl16b : OP::vsshl16b) + (elementType - TR::Int8));
    ...
    TR::Register *rhsReg, TR::CodeGenerator *cg)
{
    ...
    OP::Mnemonic cmpOp
        = static_cast<OP::Mnemonic>(OP::vcmlt16b_zero + (elementType - TR::Int8));
    OP::Mnemonic addOp
        = static_cast<OP::Mnemonic>(OP::vadd16b + (elementType - TR::Int8));
    OP::Mnemonic shiftOp
        = static_cast<OP::Mnemonic>(OP::vushl16b + (elementType - TR::Int8));
    OP::Mnemonic subOp
        = static_cast<OP::Mnemonic>(OP::vsub16b + (elementType - TR::Int8));
    ...
    if (elementType == TR::Int64) {
        ...
        OP::Mnemonic movOp = (elementType == TR::Int8)
            ? OP::vmovi16b
            : ((elementType == TR::Int16) ? OP::vmovi8h : OP::vmovi4s);
    ...
    TR::CodeGenerator *cg)
{
    ...
    const OP::Mnemonic clzOp
        = static_cast<OP::Mnemonic>(OP::vclz16b + (elementType - TR::Int8));
    ...
    if (firstChild->getOpCode().isLoadConst()) {
        if (secondChild->getOpCode().isLoadConst()) {
            if (firstChild->getInt() < secondChild->getInt()) {
                ...
                instr = generateImmSymInstruction(cg, OP::bl, node,
    ...
    TR::Instruction *cursor)
{
    ...
    if (op != OP::bad) {
        ...
        if (logicImmediateHelper(static_cast<uint32_t>(value), false, n, immEncoded)) {
            ...
            cursor = generateTrg1ImmInstruction(cg, OP::movkw, node, trgReg,
    ...
    TR::Register *trgReg, TR::Instruction *cursor = NULL, int16_t typeAddress = -1)
{
    ...
    cursor = firstInstruction
        = generateTrg1ImmInstruction(cg, OP::movzx, node, trgReg, value & 0x0000ffff, cursor);
    cursor = generateTrg1ImmInstruction(cg, OP::movkx, node, trgReg,
        ((value >> 16) & 0x0000ffff) | TR::MOV_LSL16, cursor);
    cursor = generateTrg1ImmInstruction(cg, OP::movkx, node, trgReg,
        ((value >> 32) & 0x0000ffff) | (TR::MOV_LSL16 * 2), cursor);
    cursor = generateTrg1ImmInstruction(cg, OP::movkx, node, trgReg, (value >> 48) | (TR::MOV_LSL16 * 3),
        cursor);
...
TR::Register *OMR::ARM64::TreeEvaluator::astoreEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
    ...
    bool isCompressedClassPointerOfObjectHeader = TR::Compiler->om.generateCompressedObjectHeaders()
        && (node->getSymbol()->isClassObject()
            || (node->getSymbolReference() == comp->getSymRefTab()->findVftSymbolRef()));
    OP::Mnemonic op
        = isCompressedClassPointerOfObjectHeader ? OP::strimmw : OP::strimmx;
...
TR::Register *OMR::ARM64::TreeEvaluator::arraysetEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
    ...
    if (isLengthConstant) {
        ...
        if (length >= elementSize * 4) {
            ...
            if (length >= 32) {
                ...
                if (length >= alignmentThresholdLength) {
                    generateMemSrc2Instruction(cg, OP::vstpoffq, node,
                    ...
                    if (useLoop) {
                        ...
                        generateMemSrc2Instruction(cg, OP::vstppreq, node,
                    ...
                    if (lenMod32 <= elementSize) {
                         ...
                         */
                        generateMemSrc1Instruction(cg, OP::vsturq, node,
                    ...
                    if (lenMod32 == 0) {
                        ...
                        if (lenMod32 == 16) {
                            ...
                            TR::Register *dstEndReg = srm->findOrCreateScratchRegister();
                            generateTrg1Src1ImmInstruction(cg, OP::addimmx, node, dstEndReg, dstReg,
                                length);
                            if (lenMod32 > 16) {
                                generateMemSrc2Instruction(cg, OP::vstpoffq, node,
                                    TR::MemoryReference::createWithDisplacement(cg, dstEndReg, -32), vectorValueReg,
                ...
                OP::Mnemonic op = (length == 16) ? OP::vstrimmq
                    : (length == 8)                          ? OP::vstrimmd
                                                             : OP::vstrimms;
        ...
        auto branchToDoneLabelInstr
            = generateCompareBranchInstruction(cg, OP::cbzx, node, lengthReg, doneLabel);
        if (debugObj) {
        ...
        auto mod16OfDstInstr
            = generateLogicalImmInstruction(cg, OP::andimmx, node, remainderReg, dstReg, true, 3);
        ...
        auto lessThanOrEqual96LabelInstr
            = generateLabelInstruction(cg, OP::label, node, lessThanOrEqual96Label);
        ...
        if (elementSize == 8) {
            generateMemSrc1Instruction(cg,
                valueNode->getDataType().isFloatingPoint() ? OP::vstrimmd : OP::strimmx, node,
...
static TR::Register *arraycmpEvaluatorHelper(TR::Node *node, TR::CodeGenerator *cg, bool isArrayCmpLen)
{
    ...
    TR::LabelSymbol *loop16Label = generateLabelSymbol(cg);
    {
        ...
        generateTrg2MemInstruction(cg, OP::ldppostx, node, data1Reg, data3Reg,
            TR::MemoryReference::createWithDisplacement(cg, src1Reg, 16));
        generateTrg2MemInstruction(cg, OP::ldppostx, node, data2Reg, data4Reg,
    ...
    if (isLengthGreaterThan15) {
        ...
        auto adjustSrc1RegInstr
            = generateTrg1Src2Instruction(cg, OP::addx, node, src1Reg, src1Reg, lengthReg);
        ...
        branchToDoneLabelInstr3 = generateCompareBranchInstruction(cg, OP::cbzx, node, lengthReg,
    ...
    if (isArrayCmpLen) {
        ...
        auto adjustingBaseAddrInstr = generateTrg1Src2ShiftedInstruction(cg, OP::subx, node, src1Reg,
    ...
    if (!isLengthGreaterThan15) {
        ...
        generateTrg1MemInstruction(cg, OP::ldrbpost, node, data1Reg,
            TR::MemoryReference::createWithDisplacement(cg, src1Reg, 1));
        generateTrg1MemInstruction(cg, OP::ldrbpost, node, data2Reg,
        ...
        if (isArrayCmpLen) {
            ...
            auto adjustSrc1AddrInstr
                = generateTrg1Src2Instruction(cg, OP::subx, node, src1Reg, src1Reg, offReg);
            if (debugObj) {
    ...
    if (isArrayCmpLen) {
        ...
        auto done0LabelInstr
            = generateLabelInstruction(cg, OP::label, node, done0Label); /* Result: 0, 1 or 2 */
        generateCompareInstruction(cg, node, data1Reg, data2Reg, true);
        generateCSetInstruction(cg, node, resultReg, TR::CC_NE);
    ...
    TR::Register *dstReg, TR::CodeGenerator *cg)
{
    ...
    if (iteration > 1) {
        ...
        generateTrg2MemInstruction(cg, OP::vldppostq, node, dataReg1, dataReg2,
            TR::MemoryReference::createWithDisplacement(cg, srcReg, 32));
        generateMemSrc2Instruction(cg, OP::vstppostq, node,
    ...
    TR::Register *dstReg, TR::CodeGenerator *cg)
{
    ...
    if (iteration > 1) {
        ...
        // Copy 32x4 bytes in a loop
        generateTrg2MemInstruction(cg, OP::vldppreq, node, dataReg1, dataReg2,
            TR::MemoryReference::createWithDisplacement(cg, srcReg, -32));
        generateMemSrc2Instruction(cg, OP::vstppreq, node,
            TR::MemoryReference::createWithDisplacement(cg, dstReg, -32), dataReg1, dataReg2);
        generateTrg2MemInstruction(cg, OP::vldppreq, node, dataReg1, dataReg2,
    ...
    TR::Register *lengthReg, TR::RegisterDependencyConditions *deps, TR::CodeGenerator *cg)
{
    ...
    generateImmSymInstruction(cg, OP::bl, node, (uintptr_t)arrayCopyHelper->getMethodAddress(), deps,
    ...
    TR::Register *lengthReg, TR::CodeGenerator *cg)
{
    ...
    generateImmSymInstruction(cg, OP::bl, node, (uintptr_t)arrayCopyHelper->getMethodAddress(), NULL,
        arrayCopyHelper, NULL);
    ...
    generateTrg2MemInstruction(cg, OP::vldppostq, node, v30ScratchReg, v31ScratchReg,
    ...
    generateTrg1MemInstruction(cg, OP::vldrpostq, node, v30ScratchReg,
        TR::MemoryReference::createWithDisplacement(cg, srcAddrReg, 16));
    generateMemSrc1Instruction(cg, OP::vstrpostq, node,
    ...
    generateTrg1MemInstruction(cg, OP::ldrpostx, node, x3ScratchReg,
        TR::MemoryReference::createWithDisplacement(cg, srcAddrReg, 8));
    generateMemSrc1Instruction(cg, OP::strpostx, node,
    ...
    generateTrg1MemInstruction(cg, OP::ldrpostw, node, x3ScratchReg,
        TR::MemoryReference::createWithDisplacement(cg, srcAddrReg, 4));
    generateMemSrc1Instruction(cg, OP::strpostw, node,
    ...
    generateTrg1MemInstruction(cg, OP::ldrhpost, node, x3ScratchReg,
        TR::MemoryReference::createWithDisplacement(cg, srcAddrReg, 2));
    generateMemSrc1Instruction(cg, OP::strhpost, node,
    ...
    generateTrg1MemInstruction(cg, OP::ldrbpost, node, x3ScratchReg,
        TR::MemoryReference::createWithDisplacement(cg, srcAddrReg, 1));
    generateMemSrc1Instruction(cg, OP::strbpost, node,
            ...
            if (mref->hasDelayedOffset() || offset != 0) {
                ...
                if (mref->hasDelayedOffset()) {
                    ...
                    if (offset >= 0 && constantIsUnsignedImm12(offset)) {
                        generateTrg1Src1ImmInstruction(cg, OP::addimmx, node, resultReg,
...
TR::Register *OMR::ARM64::TreeEvaluator::BBEndEvaluator(TR::Node *node, TR::CodeGenerator *cg)
{
    ...
    generateAdminInstruction(cg, OP::fence, node, deps, fenceNode);
...
static TR::Register *intrinsicAtomicAdd(TR::Node *node, TR::CodeGenerator *cg)
{
    ...
    if (comp->target().cpu.supportsFeature(OMR_FEATURE_ARM64_LSE) && (!disableLSE)) {
        ...
        generateTrg1Src2Instruction(cg, (is64Bit ? OP::addx : OP::addw), node, newValueReg,
...
TR::Register *intrinsicAtomicFetchAndAdd(TR::Node *node, TR::CodeGenerator *cg)
{
    ...
    if (comp->target().cpu.supportsFeature(OMR_FEATURE_ARM64_LSE) && (!disableLSE)) {
        ...
        if (valueReg == NULL) {
            if (!negate) {
                generateTrg1Src1ImmInstruction(cg, (is64Bit ? OP::addimmx : OP::addimmw), node,
                    newValueReg, oldValueReg, value);
            } else {
                generateTrg1Src1ImmInstruction(cg, (is64Bit ? OP::subimmx : OP::subimmw), node,
                    newValueReg, oldValueReg, -value);
            }
        } else {
            generateTrg1Src2Instruction(cg, (is64Bit ? OP::addx : OP::addw), node, newValueReg,

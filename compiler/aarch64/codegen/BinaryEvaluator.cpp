    ...
    TR::Node *addOrSubFromNode)
{
    ...
    // vmla/vmls/vfmla/vfmls instructions reuse one of the source registers as the destination register
    TR::Register *resReg;
    ...
    if (!disableVectorAddToFMA && !node->getOpCode().isVectorMasked()
        ...
        switch (et) {
            ...
            case TR::Int64:
                ...
                break;
            case TR::Float:
                fusedMulOp = OP::vfmla4s;
                break;
            case TR::Double:
                fusedMulOp = OP::vfmla2d;
                break;
        }
    ...
    if (!disableVectorSubToFMS && !node->getOpCode().isVectorMasked() && secondChild->getOpCode().isMul()
        ...
        switch (et) {
            ...
            case TR::Int64:
                ...
                break;
            case TR::Float:
                fusedMulOp = OP::vfmls4s;
                break;
            case TR::Double:
                fusedMulOp = OP::vfmls2d;
                break;
        }
        if (fusedMulOp != OP::bad) {

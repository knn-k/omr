...
static TR::Register *commonFpEvaluator(TR::Node *node, OP::Mnemonic op, bool isDouble,
    TR::CodeGenerator *cg)
{
...
static TR::Register *commonFpUnaryEvaluator(TR::Node *node, OP::Mnemonic op, bool isDouble,
    TR::CodeGenerator *cg)
{
    TR::Node *firstChild = node->getFirstChild();

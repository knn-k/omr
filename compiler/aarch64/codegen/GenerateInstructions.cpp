...
TR::ARM64ImmInstruction *generateImmInstruction(TR::CodeGenerator *cg, OP::Mnemonic op, TR::Node *node,
...
TR::Instruction *generateImmSymInstruction(TR::CodeGenerator *cg, OP::Mnemonic op, TR::Node *node,
...
TR::Instruction *generateLabelInstruction(TR::CodeGenerator *cg, OP::Mnemonic op, TR::Node *node,
    ...
    TR::ARM64ConditionCode cc, TR::Instruction *preced)
{
    if (preced)
        return new (cg->trHeapMemory())
            TR::ARM64ConditionalBranchInstruction(OP::b_cond, node, sym, cc, preced, cg);
    ...
    TR::ARM64ConditionCode cc, TR::RegisterDependencyConditions *cond, TR::Instruction *preced)
{
    ...
    return new (cg->trHeapMemory())
        TR::ARM64ConditionalBranchInstruction(OP::b_cond, node, sym, cc, cond, cg);
}
...
TR::Instruction *generateTrgInstruction(TR::CodeGenerator *cg, OP::Mnemonic op, TR::Node *node,
    TR::Register *treg, TR::Instruction *preced)
{
    if (preced)
...
TR::Instruction *generateTrg1ImmInstruction(TR::CodeGenerator *cg, OP::Mnemonic op, TR::Node *node,
...
TR::Instruction *generateTrg1Src1Instruction(TR::CodeGenerator *cg, OP::Mnemonic op, TR::Node *node,
    ...
    TR::Register *treg, TR::Register *s1reg, uint32_t imm, TR::Instruction *preced)
{
    ...
    if ((op == OP::addimmx) || (op == OP::addimmw) || (op == OP::addsimmx)
        || (op == OP::addsimmw) || (op == OP::subimmx) || (op == OP::subimmw)
        || (op == OP::subsimmx) || (op == OP::subsimmw)) {
...
TR::Instruction *generateTrg1Src2Instruction(TR::CodeGenerator *cg, OP::Mnemonic op, TR::Node *node,
...
TR::Instruction *generateTrg1Src2IndexedElementInstruction(TR::CodeGenerator *cg, OP::Mnemonic op,
...
TR::Instruction *generateTrg1Src3Instruction(TR::CodeGenerator *cg, OP::Mnemonic op, TR::Node *node,
...
TR::Instruction *generateTrg1MemInstruction(TR::CodeGenerator *cg, OP::Mnemonic op, TR::Node *node,
...
TR::Instruction *generateTrg2MemInstruction(TR::CodeGenerator *cg, OP::Mnemonic op, TR::Node *node,
...
TR::Instruction *generateSrc1Instruction(TR::CodeGenerator *cg, OP::Mnemonic op, TR::Node *node,
...
TR::Instruction *generateSrc2Instruction(TR::CodeGenerator *cg, OP::Mnemonic op, TR::Node *node,
...
TR::Instruction *generateConditionalCompareImmInstruction(TR::CodeGenerator *cg, TR::Node *node, TR::Register *sreg,
    ...
    TR::Instruction *preced)
{
    OP::Mnemonic op = is64bit ? (isNegative ? OP::ccmnimmx : OP::ccmpimmx)
                                          : (isNegative ? OP::ccmnimmw : OP::ccmpimmw);
...
TR::Instruction *generateConditionalCompareInstruction(TR::CodeGenerator *cg, TR::Node *node, TR::Register *sreg1,
    ...
    TR::Instruction *preced)
{
    OP::Mnemonic op = is64bit ? (isNegative ? OP::ccmnx : OP::ccmpx)
                                          : (isNegative ? OP::ccmnw : OP::ccmpw);
...
TR::ARM64SynchronizationInstruction *generateSynchronizationInstruction(TR::CodeGenerator *cg,
    OP::Mnemonic op, TR::Node *node, OP::AArch64BarrierLimitation lim, TR::Instruction *preced)
{
    if (preced)
...
TR::ARM64ExceptionInstruction *generateExceptionInstruction(TR::CodeGenerator *cg, OP::Mnemonic op,
    ...
    uint32_t lsb, uint32_t width, bool is64bit, TR::Instruction *preced)
{
    ...
    return generateTrg1Src1ImmInstruction(cg, is64bit ? OP::ubfmx : OP::ubfmw, node, treg, sreg,
        (immr << 6) | imms, preced);
}
    ...
    uint32_t lsb, uint32_t width, bool is64bit, TR::Instruction *preced)
{
    ...
    return generateTrg1Src1ImmInstruction(cg, is64bit ? OP::bfmx : OP::bfmw, node, treg, sreg,
        (immr << 6) | imms, preced);
}

TR::Instruction *generateVectorShiftImmediateInstruction(TR::CodeGenerator *cg, OP::Mnemonic op,
...
TR::Instruction *generateMovVectorElementToGPRInstruction(TR::CodeGenerator *cg, OP::Mnemonic op,
    TR::Node *node, TR::Register *treg, TR::Register *sreg, uint32_t srcIndex, TR::Instruction *preced)
{
    ...
    const uint32_t elementSizeShift = (op >= OP::umovwb)
        ? (op - OP::umovwb)
        : ((op >= OP::smovxb) ? (op - OP::smovxb) : (op - OP::smovwb));
    const uint32_t nelements = 16 >> elementSizeShift;
    TR_ASSERT_FATAL_WITH_NODE(node, (srcIndex < nelements),
        "srcIndex (%d) must be less than the number of elements (%d)", srcIndex, nelements);
...
TR::Instruction *generateMovGPRToVectorElementInstruction(TR::CodeGenerator *cg, OP::Mnemonic op,
